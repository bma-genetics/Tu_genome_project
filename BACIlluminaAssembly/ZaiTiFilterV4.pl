...
my $PSLFileR1  = './ZaiTiPSLData/'.$PreFixR1.'.psl';
my $PSLFileR2  = './ZaiTiPSLData/'.$PreFixR2.'.psl';

my $FastAInFileR1  = './XiJunFilteredFasta/'.$PreFixR1.'-XiJunFiltered.fasta';
my $FastAInFileR2  = './XiJunFilteredFasta/'.$PreFixR2.'-XiJunFiltered.fasta';

my $FastAOutFileR1  = './ZaiTiFilteredFasta/'.$PreFixR1.'-ZaiTiFiltered.fasta';
my $FastAOutFileR2  = './ZaiTiFilteredFasta/'.$PreFixR2.'-ZaiTiFiltered.fasta';
