...
sub createJob{
    ...
    foreach my $SampleHorizontal ( @SampleArrayHorizontal ) {
        ...
        foreach my $SampleVertical ( @SampleArrayVertical ){
            ...
            if( ! -e "./AssemblyMatePairResult/$SampleHorizontal-$SampleVertical.final.scaffolds.fasta"){
                
                system("ls -l ./AssemblyMatePairResult/$SampleHorizontal-$SampleVertical.final.scaffolds.fasta");
...
SET
                ...
                system("ls -l $SampleHorizontal-$SampleVertical-AssemblyMatePair.pbs");
                system("qsub  $SampleHorizontal-$SampleVertical-AssemblyMatePair.pbs");
            }
            
            # system ( "cp ./AssemblyMatePair/$SampleHorizontal-$SampleVertical/$SampleHorizontal-$SampleVertical.final.scaffolds.fasta ./AssemblyMatePairResult/$SampleHorizontal-$SampleVertical.final.scaffolds.fasta " );
