...
#　根据过滤后的比对结果计算出Contig是头还是尾（以及包含关系）比对到Pacbio上（Pacbio方向固定）
#  同时输出Strand，Score，Identity，和 Pacbio与Contig比对上的坐标和长度
...
while ( my $line = <IN> ) {
    ...
    if ( $qStrand == 0 && $ tStrand == 0 ) {
        ...
        # m.../0_18694	contig9_size44098	0	    0	    -76540	99.8438	            0	    15360	44098	4340	19696	19696	322487
            ...
            print "head\tforward\t$percentSimilarity\t$score\t$tName\t$qName\ttail\t$qStart\t$qEnd\t$qLength\t$tStart	$tEnd	$tLength\n";
        ...
        # m.../6331_12271	contig11_size14782	0	    0	    -20685	100.00 	            10645	14782	14782	5	    4142	5640	86843
            ...
            print "tail\tforward\t$percentSimilarity\t$score\t$tName\t$qName\thead\t$qStart\t$qEnd\t$qLength\t$tStart	$tEnd	$tLength\n";
        ...
        #　m.../32347_45832	    contig11_size14782	0	    1	    -18870	100.00 	            11008	14782	14782	0	    3774	13374	79220
            ...
            print "head\treverse\t$percentSimilarity\t$score\t$tName\t$qName\thead\t$qStart\t$qEnd\t$qLength\t$tStart	$tEnd	$tLength\n";
        ...
        # m...2558_18452	contig11_size14782	0	    1	    -64185	95.74 	            0	    13496	14782	1282	15296	15297	416624
            ...
            print "tail\treverse\t$percentSimilarity\t$score\t$tName\t$qName\ttail\t$qStart\t$qEnd\t$qLength\t$tStart	$tEnd	$tLength\n";
